...
class Line(object):
    ...
    def length(self):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        distance = math.sqrt((self.end.y - self.start.y)**2 + (self.end.x - self.start.x)**2)
        return distance
    ...
    def line_plus(self, other_line):
        ...
        start.x = self.start.x + other_line.start.x
        start.y = self.start.y + other_line.start.y
        end.x = self.end.x + other_line.end.x
        end.y = self.end.y + other_line.end.y
        line = Line(start, end)
        return line
    ...
    def midpoint(self):
        ...
        # --------------------------------------------------------------
        mp = Point(0, 0)
        mp.x = (self.start.x + self.end.x) / 2
        mp.y = (self.start.y + self.end.y) / 2
        return mp
